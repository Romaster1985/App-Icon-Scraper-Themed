...
class IconAdapter(
    private val icons: List<MainActivity.IconItem>,
    private val mappings: List<MainActivity.IconMapping>,
    private val onIconClick: (MainActivity.IconItem) -> Unit
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.iconName.text = iconItem.displayName
